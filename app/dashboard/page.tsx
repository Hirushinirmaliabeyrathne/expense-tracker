...
//   // Fix: Explicitly type expenseData as Expense
...
//       (acc, expense: Expense) => { // Fix: Explicitly type expense as Expense
...
//       values: [280, 300, 250, totalExpenses],
//     }
...
//           ) : (
//             expenses.slice(0, 5).map((expense: Expense) => ( // Fix: Explicitly type expense as Expense
//               <div
//                 key={expense._id}
...
//       {/* Add Expense Modal */}
//       <AddExpenseModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onAddExpense={handleAddExpense} categories={[]} />
//     </div>
//   )
// }
